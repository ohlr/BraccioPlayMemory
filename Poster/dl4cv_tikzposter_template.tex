    ...
    \block{Related Work}{
	  \begin{minipage}{\columnwidth}
	  		    	\begin{minipage}{800 pt}
	  		    		       	...
	  		    		       	\normalfont
	  		    		       	Yolo uses anchor boxes to predict bounding boxes\\
	  		    		       	Labels trained with ImageNet at the full 448 x 448 resolution for 10 epochs \\
	  		    		       	\bfseries 
	  		    		       	What makes it fast and accurate?
	  		    		       	\normalfont
	  		    		       	Simplify network, make representations easier to learn\\
	  		    		       	Don't use VGG-16 network, but custom network based on Googlenet architecture (less accurate)
	  		    	\end{minipage}
	  		    	\hspace{50 pt}
