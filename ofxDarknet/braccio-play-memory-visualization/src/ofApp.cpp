...
void ofApp::setup()
{
    ...
    std::string cfgfile = ofToDataPath( "../../../darknet/cfg/yolo-obj-webCam.cfg" );
    std::string weightfile = ofToDataPath( "../../../darknet/TrainTinyTiny/yolo-obj-1200.weights" );
    std::string nameslist = ofToDataPath( "../../../darknet/cfg/obj.names" );
